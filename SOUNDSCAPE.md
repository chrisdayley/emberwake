...
Intensity follows expedition survival time. Snare, hats, extra kicks and pulses join gradually; the melody becomes denser in long runs. Intensity caps at 20 minutes for bounded endless playback. Pausing, choosing upgrades, returning to camp or backgrounding stops the score. Music resumes at the saved run's intensity after a user gesture. Settings provide an independent music toggle and volume; existing sound-off saves remain muted by default.
