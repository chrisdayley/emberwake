export const WEAPONS = [
 {id:'bolt',name:'Ember bolt',icon:'↗',color:'#ffc477',desc:'Seeks the nearest enemy. Reliable, piercing firepower.',base:'22 damage · fires every 0.8s',upgrade:'More damage, more bolts, deeper piercing.',evo:'Sunpiercer',pair:'power',evoDesc:'A volley of five piercing sunbolts.'},
 {id:'orbit',name:'Moon blades',icon:'✧',color:'#b6a7ff',desc:'Blades circle you and cut through nearby enemies.',base:'18 damage · 2 orbiting blades',upgrade:'Another blade and a wider, stronger orbit.',evo:'Lunar covenant',pair:'reach',evoDesc:'Seven blades carve a circle of protection.'},
 {id:'chain',name:'Storm thread',icon:'ϟ',color:'#8bdaf5',desc:'Lightning leaps between enemies. Loves a crowd.',base:'30 damage · chains to 3 targets',upgrade:'More damage and another lightning jump.',evo:'Skybreaker',pair:'haste',evoDesc:'Rapid lightning leaps across twelve targets.'},
 ...
 {id:'dagger',name:'Ghost knives',icon:'⋗',color:'#c9e5ce',desc:'A quick fan of blades shreds a path through the swarm.',base:'16 damage · 3 knives · every 1.1s',upgrade:'More knives, damage, and piercing.',evo:'Thousand cuts',pair:'luck',evoDesc:'An eight-blade fan that tears through entire packs.'},
...
export const MILESTONES=[
 ...
 {id:'eight',name:'Almost dawn',desc:'Survive 8 minutes in one run',stat:'bestTime',target:480,reward:100},
 {id:'dawn',name:'A new dawn',desc:'Complete a full expedition',stat:'wins',target:1,reward:150},
 {id:'veteran',name:'Dawnkeeper',desc:'Complete 5 expeditions',stat:'wins',target:5,reward:300},
