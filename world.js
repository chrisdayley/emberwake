...
export function isSafePoint(region,x,y,r=32){
 if(!challengeSafe(region,x,y))return false;
 for(const b of challengeWalls(region,x,y))if(x>b.x-r&&x<b.x+b.w+r&&y>b.y-r&&y<b.y+b.h+r)return false;
